...
exports.OrganSaldoService = class {
    static async create(data) {
        ...
        const result = await db.transaction(async client => {
            ...
            await this.createChild({ childs: data.childs, client, parent_id: doc.id, user_id: data.user_id, main_schet_id: data.main_schet_id });
    ...
    static async update(data) {
        ...
        const result = await db.transaction(async client => {
            ...
            await this.createChild({ childs: create_childs, client, parent_id: doc.id, user_id: data.user_id, main_schet_id: data.main_schet_id });
