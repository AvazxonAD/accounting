...
const {
  ...
  deleteShartnomaDB,
} = require("@contract/shartnoma.service.js");
const { SmetaDB } = require("@smeta/db.js");
...
const { createShartnomaGrafik } = require("@contract_grafik/shartnoma.grafik.service.js");
...
const { getByIdBudjetService } = require('@budjet/budjet.name.service.js');
