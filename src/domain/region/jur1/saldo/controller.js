...
exports.Controller = class {
  static async cleanData(req, res) {
    ...
    await KassaSaldoService.cleanData({ main_schet_id });
  ...
  static async createAuto(req, res) {
    ...
    const last_saldo = await KassaSaldoService.getByMonth({
      region_id,
      year: last_date.year,
    ...
    const response = await KassaSaldoService.createAuto({
  ...
  static async delete(req, res) {
    ...
    const end_saldo = await KassaSaldoService.getEndSaldo({
      region_id,
      main_schet_id,
    });
    if (end_saldo.id !== id) {
