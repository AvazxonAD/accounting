...
exports.OdinoxService = class {
  ...
  static async getOdinoxType(data) {
  ...
  static async getCheck(data) {
    const result = await OdinoxDB.getCheck([
      data.region_id,
      data.main_schet_id,
    ]);
  ...
  static async getJur1PrixodDocs(data) {
    const result = await OdinoxDB.getJur1PrixodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur1RasxodDocs(data) {
    const result = await OdinoxDB.getJur1RasxodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur2PrixodDocs(data) {
    const result = await OdinoxDB.getJur2PrixodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur2RasxodDocs(data) {
    const result = await OdinoxDB.getJur2RasxodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur3PrixodDocs(data) {
    ...
    const result = await OdinoxDB.getJur3PrixodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur3RasxodDocs(data) {
    const result = await OdinoxDB.getJur3RasxodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur4PrixodDocs(data) {
    ...
    const result = await OdinoxDB.getJur4PrixodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur4RasxodDocs(data) {
    const result = await OdinoxDB.getJur4RasxodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur7PrixodDocs(data) {
    const result = await OdinoxDB.getJur7PrixodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur7RasxodDocs(data) {
    const result = await OdinoxDB.getJur7RasxodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async getJur8PrixodDocs(data) {
    const result = await OdinoxDB.getJur8PrixodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
    ...
    const response = await OdinoxDB.get8Docs(result);

    return response;
  }

  static async getJur8RasxodDocs(data) {
    const result = await OdinoxDB.getJur8RasxodDocs([
      data.year,
      data.month,
      data.main_schet_id,
      data.schet,
  ...
  static async cleanData(data) {
    ...
    await db.transaction(async (client) => {
      await OdinoxDB.cleanData([ids], client);
    });
  }

  static async getCheckFirst(data) {
    const result = await OdinoxDB.getCheckFirst([
      data.main_schet_id,
      data.region_id,
    ]);
  ...
  static async getEndMainBook(data) {
    const result = await OdinoxDB.getEndMainBook([
      data.main_schet_id,
      data.region_id,
    ]);
  ...
  static async getJurSchets(data) {
    const result = await OdinoxDB.getJurSchets([data.main_schet_id]);
  ...
  static async delete(data) {
    await db.transaction(async (client) => {
      ...
      await OdinoxDB.unblockSaldo([data.id], client);
    });
  }
    ...
    const result = await db.transaction(async (client) => {
      ...
      for (let child of data.old_data.childs) {
        for (let sub_child of child.sub_childs) {
          ...
          if (!check) {
            await OdinoxDB.deleteChild([sub_child.id], client);
          }
        }
      }
    ...
    for (let type of data.types) {
      if (type.id !== 9 && type.id !== 0 && type.id !== 10) {
        for (let child of type.sub_childs) {
          const child_index = data.types[index].sub_childs.findIndex(
  ...
  static async getJur1Data(data) {
    for (let main_schet of data.main_schets) {
      ...
      const rasxod_data = await OdinoxDB.getJur1Rasxod(
  ...
  static async getJur2Data(data) {
    for (let main_schet of data.main_schets) {
      ...
      const rasxod_data = await OdinoxDB.getJur2Rasxod(
        [data.region_id, main_schet.id],
        { from: data.from, to: data.to },
        data.operator
      );
  ...
  static async getJur3Data(data) {
    ...
    const rasxod_data = await OdinoxDB.getJur3Rasxod(
  ...
  static async getJur8Data(data) {
    const rasxod_data = await OdinoxDB.getJur8Rasxod([
      data.region_id,
      data.main_schet_id,
      data.year,
      data.month,
  ...
  static async getJur4Data(data) {
    ...
    const rasxod_data = await OdinoxDB.getJur4Rasxod(
  ...
  static async getJur7Data(data) {
    const rasxod_data = await OdinoxDB.getJur7Rasxod(
  ...
  static async checkLarge(data) {
    const check = await OdinoxDB.checkLarge([
      data.region_id,
      data.year,
      data.month,
      data.main_schet_id,
