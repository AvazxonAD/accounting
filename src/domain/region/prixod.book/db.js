...
exports.PrixodBookDB = class {
  ...
  static async delete(params, client) {
    const query = `UPDATE prixod_book SET isdeleted = true WHERE id = $1`;

    await client.query(query, params);
  }

  static async deleteChildByParentId(params, client) {
    const query = `UPDATE prixod_book_child SET isdeleted = true WHERE parent_id = $1`;
  ...
  static async deleteChild(params, client) {
    const query = `UPDATE prixod_book_child SET isdeleted = true WHERE id = $1`;
  ...
  static async gerPrixodBookType(params) {
    const query = `SELECT * FROM prixod_book_type ORDER BY sort_order`;
  ...
  static async getJur7Prixod(params, date, operator = null) {
    let date_filter = ``;
