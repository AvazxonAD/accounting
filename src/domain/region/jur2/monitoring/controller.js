...
exports.Controller = class {
  static async reportBySchets(req, res) {
    ...
    const data = await BankMonitoringService.reportBySchets({
      region_id,
      main_schet_id,
      saldo,
      from,
  ...
  static async get(req, res) {
    const region_id = req.user.region_id;
    const { page, limit, main_schet_id, from, to, search, order_by, order_type } = req.query;
    ...
    const { total_count, data, summa_from, summa_to, prixod_sum, rasxod_sum, page_prixod_sum, page_rasxod_sum, total_sum, page_total_sum } =
  ...
  static async daysReport(req, res) {
    const { from, to, main_schet_id, report_title_id, excel, budjet_id } = req.query;
    const region_id = req.user.region_id;
  ...
  static async prixodReport(req, res) {
    ...
    if (excel) {
      ...
      const { fileName, filePath } = await BankMonitoringService.prixodReportExcel({
        ...data,
        from,
        region,
        to,
