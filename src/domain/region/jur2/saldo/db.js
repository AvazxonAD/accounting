...
exports.BankSaldoDB = class {
  ...
  static async deleteByMonth(params, client) {
    await client.query(
      `UPDATE bank_saldo SET isdeleted = true WHERE year = $1 AND month = $2 AND main_schet_id = $3`,
      params
    );
  }
  ...
  static async deleteSaldoDateByMonth(params, client) {
    await client.query(
      `UPDATE date_saldo_jur2 SET isdeleted = true WHERE year = $1 AND month = $2 AND main_schet_id = $3`,
      params
    );
  }
};
