...
router
  .post("/", checkMainBook(MainBookService.getCheck), validator(Controller.create, MainBookSchema.create()))
  .get("/", checkMainBook(MainBookService.getCheck), validator(Controller.get, MainBookSchema.get()))
  ...
  .get("/unique", validator(Controller.getUniqueSchets, MainBookSchema.getUniqueSchets()))
  .get("/check", validator(Controller.getCheckFirst, MainBookSchema.getCheckFirst()))
