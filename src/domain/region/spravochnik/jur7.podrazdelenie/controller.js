...
exports.Controller = class {
  ...
  static async createPodrazdelenie(req, res) {
    ...
    const result = await PodrazdelenieDB.createPodrazdelenie([user_id, name, tashkentTime(), tashkentTime()]);
  ...
  static async updatePodrazdelenie(req, res) {
    ...
    const result = await PodrazdelenieDB.updatePodrazdelenie([name, tashkentTime(), id]);
    return res.status(200).json({
