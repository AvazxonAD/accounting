...
exports.Saldo159DB = class {
  ...
  static async deleteByMonth(params, client) {
    await client.query(
      ...
      WHERE id = ANY(
        ...
        JOIN saldo_159 d ON d.id = ch.parent_id
        WHERE d.year = $1
          AND d.month = $2
    ...
    await client.query(
      `UPDATE saldo_159 SET isdeleted = true WHERE year = $1 AND month = $2 AND main_schet_id = $3 AND schet_id = $4`,
      params
    );
  }
  ...
  static async cleanData(params, client) {
    const queryParent = `UPDATE saldo_159 SET isdeleted = true WHERE main_schet_id = $1 AND schet_id = $2`;
  ...
  static async delete(params, client) {
    const queryParent = `UPDATE saldo_159 SET isdeleted = true WHERE id = $1 RETURNING id`;
