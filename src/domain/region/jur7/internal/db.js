...
exports.InternalDB = class {
  ...
  static async getById(params, isdeleted) {
    ...
    const query = `--sql
            ...
            LEFT JOIN spravochnik_javobgar_shaxs_jur7 AS rj ON rj.id = d.kimdan_id
            LEFT JOIN spravochnik_podrazdelenie_jur7 rjp ON rjp.id = rj.spravochnik_podrazdelenie_jur7_id 
            LEFT JOIN spravochnik_podrazdelenie_jur7 rjp2 ON rjp.id = rj2.spravochnik_podrazdelenie_jur7_id 
            WHERE r.id = $1
              AND d.id = $2
