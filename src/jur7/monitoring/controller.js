...
exports.Controller = class {
    ...
    static async obrotkaReport(req, res) {
        ...
        const { fileName, filePath } = await Jur7MonitoringService.obrotkaExcel({ schets, region });
    ...
    static async materialReport(req, res) {
        ...
        const { fileName, filePath } = await Jur7MonitoringService.materialExcel({ responsibles: result, month, year, region });
