...
const { create_user, getAllRegionUsers, getByIdUser, update_user } = require("../../service/user.db");
...
const createUser = asyncHandler(async (req, res, next) => {
    ...
    const result = await create_user(login, hashedPassword, fio, role_id, region_id)
    if (!result) {
...
const updateUser = asyncHandler(async (req, res, next) => {
    ...
    const updateUser = await update_user(login, hashedPassword, fio, role_id, region_id, id)
    if (!updateUser) {
