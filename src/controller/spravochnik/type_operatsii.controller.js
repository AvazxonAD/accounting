...
const { getByAlltype_operatsii, createtype_operatsii, getAlltype_operatsii, getTotaltype_operatsii, getByIdtype_operatsii, updatetype_operatsii } = require("../../service/type_operatsii.db");
const { deletetype_operatsii } = require("../../service/type_operatsii.db");
