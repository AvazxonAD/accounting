...
const getByAllSmetaGrafik = handleServiceError(async (region_id, smeta_id, spravochnik_budjet_name_id, year) => {
...
const getAllSmetaGrafik = handleServiceError(async (region_id, offset, limit) => {
    const result = await pool.query(
        `SELECT 
                smeta_grafik.id, 
