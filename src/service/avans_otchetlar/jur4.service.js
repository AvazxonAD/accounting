...
const getAllJur4ChildDB = handleServiceError(async (region_id, main_schet_id, avans_otchetlar_jur4_id) => {
    const result = await pool.query(`
            ...
            JOIN spravochnik_podrazdelenie AS s_p ON s_p.id = a_o_j_4_ch.id_spravochnik_podrazdelenie
            JOIN spravochnik_sostav AS s_s ON s_s.id = a_o_j_4_ch.id_spravochnik_sostav
