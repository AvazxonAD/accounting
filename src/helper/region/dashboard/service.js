...
exports.DashboardService = class {
    ...
    static async kassa(data) {
        ...
        return { budjets: data.budjets, page_prixod_sum, page_rasxod_sum, page_total_sum };
    }
    ...
    static async podotchet(data) {
        ...
        return { podotchets: data.podotchets, page_prixod_sum, page_rasxod_sum, page_total_sum };
    }
}