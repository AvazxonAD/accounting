...
exports.GroupService = class {
    ...
    static async create(data) {
        const result = await GroupDB.create([
            ...
            data.schet,
            data.iznos_foiz,
            data.provodka_debet ? String(data.provodka_debet).replace(/\s/g, '') : null,
            data.group_number,
            data.provodka_kredit ? String(data.provodka_kredit).replace(/\s/g, '') : null,
            data.provodka_subschet ? String(data.provodka_subschet).replace(/\s/g, '') : null,
            data.roman_numeral,
            data.pod_group,
