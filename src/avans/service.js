...
exports.AktService = class {
    static async get(data) {
        const result = await AvansDB.get([data.region_id, data.main_schet_id, data.from, data.to, data.offset, data.limit], data.search);
    ...
    static async getById(data) {
        const result = await AvansDB.getById([data.region_id, data.main_schet_id, data.id], data.isdeleted);
