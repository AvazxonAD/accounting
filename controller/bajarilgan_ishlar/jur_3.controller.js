...
const jur_3_get_all = asyncHandler(async (req, res, next) => {
    ...
    let results = await pool.query(` SELECT id, doc_num, doc_date, opisanie, summa, id_spravochnik_organization, shartnomalar_organization_id
...
const jur_3_update = asyncHandler(async (req, res, next) => {
    ...
    const updateValue = await pool.query(`UPDATE bajarilgan_ishlar_jur3 SET
            doc_num = $1, 
            doc_date = $2, 
            summa = $3,
            opisanie = $4, 
    ...
    await pool.query(`DELETE FROM bajarilgan_ishlar_jur3_child WHERE bajarilgan_ishlar_jur3_id = $1`, [req.params.id])
...
const deleteJur_3 = asyncHandler(async (req, res, next) => {
    ...
    const childs = await pool.query(`UPDATE bajarilgan_ishlar_jur3_child 
        SET isdeleted = true
    ...
    const result = await pool.query(`UPDATE bajarilgan_ishlar_jur3
        SET isdeleted = true
