...
const { getAllSostav, getByAllSostav, createSostav, getTotalSostav, getByIdSostav, updateSostav, deleteSostav } = require("../../service/sostav.db");
...
const getElementById = asyncHandler(async (req, res, next) => {
    const value = await getByIdSostav(req.user.region_id, req.params.id)
    if (!value) {
        return next(new ErrorResponse('Server error. spravochnik_sostav topilmadi'))
    }
