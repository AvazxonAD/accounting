...
var _require = require('@db/index'),
  db = _require.db;
exports.DashboardDB = /*#__PURE__*/function () {
  function _class() {
  ...
  return _createClass(_class, null, [{
    key: "getBudjet",
    value: function () {
      var _getBudjet = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(params, budjet_id, main_schet_id) {
        var main_schet_filter, budjet_filter, query, result;
    ...
    key: "kassa",
    value: function () {
      var _kassa = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params) {
        var query, result;
    ...
    key: "bank",
    value: function () {
      var _bank = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params) {
        var query, result;
    ...
    key: "podotchets",
    value: function () {
      var _podotchets = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(params) {
        var query, result;
      ...
      function podotchets(_x6) {
        return _podotchets.apply(this, arguments);
      }
      return podotchets;
    }()
  }]);
