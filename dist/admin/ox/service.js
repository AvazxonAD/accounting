...
var _require2 = require('@smeta_grafik/db'),
  SmetaGrafikDB = _require2.SmetaGrafikDB;
  ...
  return _createClass(_class, null, [{
      ...
      var _getReport = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return ReportOx.getReport([], data.year, data.month);
            case 2:
    ...
    value: function () {
      var _getByIdReport = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
        var _yield$SmetaGrafikDB$, smeta_grafiks, report, _iterator2, _step2, grafik;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              _iterator2 = _createForOfIteratorHelper(report.smeta_grafiks);
              _context2.prev = 12;
              _iterator2.s();
            case 14:
              ...
              grafik = _step2.value;
              _context2.next = 18;
              return ReportOx.getSchetSummaBySchetId([data.region_id, data.year, data.month, data.budjet_id, grafik.id]);
            case 18:
              grafik.summa = _context2.sent;
              _context2.next = 21;
              return ReportOx.getByYearSumma([data.region_id, data.year, data.month, data.budjet_id, grafik.id]);
            case 21:
              grafik.year_summa = _context2.sent;
            case 22:
              _context2.next = 14;
              break;
            case 24:
      ...
      var _updateReport = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return ReportOx.updateReport([data.region_id, data.year, data.month, data.budjet_id, data.user_id_qabul_qilgan, tashkentTime(), data.status]);
            case 2:
