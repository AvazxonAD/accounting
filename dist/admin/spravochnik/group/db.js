...
var _require = require('@db/index'),
  db = _require.db;
exports.GroupDB = /*#__PURE__*/function () {
  function _class() {
  ...
  return _createClass(_class, null, [{
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              group_filter = "";
              if (search) {
                search_filter = "AND (\n                    g.name ILIKE '%' || $".concat(params.length + 1, " || '%' OR \n                    g.provodka_subschet ILIKE '%' || $").concat(params.length + 1, " || '%' OR \n                    g.schet ILIKE '%' || $").concat(params.length + 1, " || '%' OR \n                    g.provodka_debet ILIKE '%' || $").concat(params.length + 1, " || '%' OR \n                    g.group_number ILIKE '%' || $").concat(params.length + 1, " || '%' OR \n                    g.provodka_kredit ILIKE '%' || $").concat(params.length + 1, " || '%'\n                )\n            ");
                params.push(search);
              }
              if (id) {
                params.push(id);
      ...
      var _getById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params, isdeleted) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ignore = 'AND g.isdeleted = false';
              query = "--sql\n            SELECT \n                g.id, \n                g.smeta_id,\n                g.name, \n                g.schet, \n                g.iznos_foiz, \n                g.provodka_debet, \n                g.group_number, \n                g.provodka_kredit,\n                g.provodka_subschet,\n                g.roman_numeral,\n                g.pod_group,\n                s.smeta_name,\n                s.smeta_number\n            FROM group_jur7 AS g\n            LEFT JOIN smeta AS s ON s.id = g.smeta_id\n            WHERE g.id = $1 ".concat(isdeleted ? "" : ignore, "\n        ");
              _context3.next = 4;
              return db.query(query, params);
            case 4:
    ...
    key: "getByNumberName",
    value: function () {
      var _getByNumberName = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(params) {
        var query, result;
    ...
    key: "update",
    value: function () {
      var _update = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params) {
        var query, result;
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(params) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              query = "UPDATE group_jur7 SET isdeleted = true WHERE id = $1 RETURNING id";
              _context7.next = 3;
              return db.query(query, params);
            case 3:
              data = _context7.sent;
    ...
    key: "getWithPercent",
    value: function () {
      var _getWithPercent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        var query, data;
