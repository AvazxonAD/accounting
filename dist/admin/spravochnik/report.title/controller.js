...
var _require = require('./service'),
  ReportTitleService = _require.ReportTitleService;
  ...
  return _createClass(_class, null, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              name = req.body.name;
              _context.next = 3;
              return ReportTitleService.getByName({
                name: name
              });
            case 3:
              check = _context.sent;
              ...
              return _context.abrupt("return", res.error(req.i18n.t('ReportTitleAlreadyExists'), 409));
            case 6:
              _context.next = 8;
              return ReportTitleService.create({
                name: name
              });
            case 8:
    ...
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var _req$query, page, limit, search, offset, _yield$ReportTitleSer, data, total, pageCount, meta;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              offset = (page - 1) * limit;
              _context2.next = 4;
              return ReportTitleService.get({
                offset: offset,
                limit: limit,
                search: search
              });
            case 4:
              _yield$ReportTitleSer = _context2.sent;
              data = _yield$ReportTitleSer.data;
              total = _yield$ReportTitleSer.total;
      ...
      var _getById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 6:
              return _context3.abrupt("return", res.success(req.i18n.t('getSuccess'), 200, null, data));
            case 7:
            case "end":
    ...
    value: function () {
      var _update = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        var name, id, old_data, check, result;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 10:
              ...
              return _context4.abrupt("return", res.error(req.i18n.t('ReportTitleAlreadyExists'), 409));
            case 13:
              _context4.next = 15;
              return ReportTitleService.update({
                name: name,
                id: id
              });
            case 15:
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 6:
              _context5.next = 8;
              return ReportTitleService["delete"]({
                id: id
              });
            case 8:
              response = _context5.sent;
              return _context5.abrupt("return", res.success(req.i18n.t('deleteSuccess'), 200, null, response));
            case 10:
            case "end":
