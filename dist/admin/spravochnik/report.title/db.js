...
var _require = require('@db/index'),
  db = _require.db;
exports.ReportTitleDB = /*#__PURE__*/function () {
  function _class() {
  ...
  return _createClass(_class, null, [{
      ...
      var _getById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params, isdeleted) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ignore = 'AND rt.isdeleted = false';
              query = "--sql\n            SELECT \n                rt.* \n            FROM report_title AS rt\n            WHERE rt.id = $1 ".concat(isdeleted ? "" : ignore, "\n        ");
              _context3.next = 4;
              return db.query(query, params);
            case 4:
    ...
    key: "delete",
    value: function () {
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params) {
        var query, data;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              query = "UPDATE report_title SET isdeleted = true WHERE id = $1 AND isdeleted = false RETURNING *";
              _context6.next = 3;
              return db.query(query, params);
            case 3:
              data = _context6.sent;
