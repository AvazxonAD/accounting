...
exports.SaldoDB = /*#__PURE__*/function () {
  ...
  return _createClass(_class, null, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              search = _args.length > 2 && _args[2] !== undefined ? _args[2] : null;
              product_id = _args.length > 3 && _args[3] !== undefined ? _args[3] : null;
              region_id = _args.length > 4 && _args[4] !== undefined ? _args[4] : null;
              responsible_filter = "";
              filter = "";
              product_filter = "";
              region_filter = "";
              ...
              if (search) {
                params.push(search);
                filter = "AND n.name ILIKE '%' || $".concat(params.length, " || '%'");
              }
              if (responsible_id) {
    ...
    key: "getKolAndSumma",
    value: function () {
      var _getKolAndSumma = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params) {
        var start,
          end,
          responsible_id,
          start_filter,
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              start = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : null;
              end = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : null;
              responsible_id = _args2.length > 3 && _args2[3] !== undefined ? _args2[3] : null;
              start_filter = "";
              end_filter = "";
              between_filter = "";
              responsible_filter = "";
