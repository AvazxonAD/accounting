...
var router = Router();
router.post('/', validator(Controller.createDoc, createDocSchema)).get('/id', validator(Controller.getByIdDoc, getByIdDocSchema)).put('/', validator(Controller.updateDoc, updateDocSchema))["delete"]('/', validator(Controller.deleteDoc, deleteDocSchema)).get('/', validator(Controller.getDoc, getDocSchema));
