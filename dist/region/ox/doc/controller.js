...
var _require3 = require('./service'),
  OxDocService = _require3.OxDocService;
var _require4 = require('@helper/functions'),
  checkUniqueIds = _require4.checkUniqueIds;
var _require5 = require('@smeta_grafik/service'),
  SmetaGrafikService = _require5.SmetaGrafikService;
  ...
  return _createClass(_class, null, [{
    ...
    value: function () {
      var _createDoc = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var region_id, user_id, budjet_id, main_schet_id, _req$body, month, year, childs, budjet, main_schet, doc, _iterator, _step, child, smeta, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _req$body = req.body, month = _req$body.month, year = _req$body.year, childs = _req$body.childs;
              _context.next = 7;
            ...
            case 15:
              _context.next = 17;
              return OxDocService.getByIdDoc({
                region_id: region_id,
                budjet_id: budjet_id,
                year: year,
                month: month
            ...
            case 20:
              ...
              return _context.abrupt("return", res.error('Duplicate id found in smetas', 400));
            case 22:
            ...
            case 29:
              ...
              return _context.abrupt("return", res.error('Smeta not found', 404));
            case 32:
              child.ajratilgan_mablag = smeta["oy_".concat(month)];
            case 33:
              _context.next = 25;
              break;
            case 35:
    ...
    value: function () {
      var _getDoc = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var region_id, _req$query, budjet_id, year, month, budjet, docs;
    ...
    value: function () {
      var _updateDoc = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        var region_id, user_id, budjet_id, main_schet_id, query, body, budjet, main_schet, old_doc, doc, _iterator2, _step2, child, smeta, result;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 27:
              ...
              return _context4.abrupt("return", res.error('Duplicate id found in smetas', 400));
            case 29:
            ...
            case 36:
              ...
              return _context4.abrupt("return", res.error('Smeta not found', 404));
            case 39:
              child.ajratilgan_mablag = smeta["oy_".concat(body.month)];
            case 40:
              _context4.next = 32;
              break;
            case 42:
      ...
      var _getByGrafikSumma = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 7:
              _context6.next = 9;
              return OxDocService.getByGrafikSumma({
                region_id: region_id,
                year: year,
                month: month,
                budjet_id: budjet_id,
