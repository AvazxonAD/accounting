...
var Joi = require('joi');
exports.OrganSaldoSchema = /*#__PURE__*/function () {
  function _class() {
    ...
    value: function create() {
      return Joi.object({
        body: Joi.object({
          ...
          organ_id: Joi.number().min(1).integer().required(),
          contract_id: Joi.number().min(1).integer().allow(null),
          contract_grafik_id: Joi.number().min(1).integer().allow(null),
          organ_account_number_id: Joi.number().min(1).integer().allow(null),
          organ_gazna_number_id: Joi.number().min(1).integer().allow(null),
