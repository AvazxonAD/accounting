...
var _require = require('@db/index'),
  db = _require.db;
exports.OrganSaldoDB = /*#__PURE__*/function () {
  function _class() {
      ...
      var _deleteChild = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params, client) {
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return client.query("UPDATE organ_saldo_child SET isdeleted = true WHERE id = $1", params);
            case 2:
            case "end":
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(params, client) {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              _context8.next = 2;
              return client.query("UPDATE organ_saldo_child SET isdeleted = true WHERE parent_id = $1", params);
            case 2:
              _context8.next = 4;
              return client.query("UPDATE organ_saldo SET isdeleted = true WHERE id = $1 RETURNING id", params);
            case 4:
