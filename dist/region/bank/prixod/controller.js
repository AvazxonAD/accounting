...
var _require8 = require('./service'),
  BankPrixodService = _require8.BankPrixodService;
  ...
  return _createClass(_class, null, [{
    ...
    value: function () {
      var _create = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var main_schet_id, user_id, region_id, _req$body, childs, id_spravochnik_organization, id_shartnomalar_organization, organization_by_raschet_schet_id, organization_by_raschet_schet_gazna_id, shartnoma_grafik_id, main_schet, organization, contract, grafik, account_number, gazna, operatsiis, _iterator, _step, child, operatsii, podraz, sostav, _operatsii, podotchet, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _req$body = req.body, childs = _req$body.childs, id_spravochnik_organization = _req$body.id_spravochnik_organization, id_shartnomalar_organization = _req$body.id_shartnomalar_organization, organization_by_raschet_schet_id = _req$body.organization_by_raschet_schet_id, organization_by_raschet_schet_gazna_id = _req$body.organization_by_raschet_schet_gazna_id, shartnoma_grafik_id = _req$body.shartnoma_grafik_id;
              _context.next = 6;
            ...
            case 84:
              ...
              _context.next = 87;
              return BankPrixodService.create(_objectSpread(_objectSpread({}, req.body), {}, {
    ...
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var region_id, _req$query, page, limit, from, to, main_schet_id, search, main_schet, offset, _yield$BankPrixodServ, data, total_count, summa, page_summa, pageCount, meta;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 10:
              _yield$BankPrixodServ = _context2.sent;
              data = _yield$BankPrixodServ.data;
              total_count = _yield$BankPrixodServ.total_count;
              summa = _yield$BankPrixodServ.summa;
              page_summa = _yield$BankPrixodServ.page_summa;
      ...
      var _getById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 8:
              _context3.next = 10;
              return BankPrixodService.getById({
                region_id: region_id,
                main_schet_id: main_schet_id,
                id: id,
                isdeleted: true
    ...
    value: function () {
      var _update = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        var main_schet_id, region_id, id, user_id, _req$body2, id_spravochnik_organization, id_shartnomalar_organization, childs, organization_by_raschet_schet_id, organization_by_raschet_schet_gazna_id, shartnoma_grafik_id, main_schet, doc, organization, contract, grafik, account_number, gazna, operatsiis, _iterator2, _step2, child, operatsii, podraz, sostav, _operatsii2, podotchet, result;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 84:
              _context4.prev = 84;
              _context4.t0 = _context4["catch"](46);
            ...
            case 90:
              ...
              _context4.next = 93;
              return BankPrixodService.update(_objectSpread(_objectSpread({}, req.body), {}, {
                main_schet_id: main_schet_id,
                user_id: user_id,
                id: id
              }));
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 13:
              _context5.next = 15;
              return BankPrixodService["delete"]({
                id: id
              });
            case 15:
