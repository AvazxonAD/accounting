...
var _require = require('@db/index'),
  db = _require.db;
exports.BankPrixodDB = /*#__PURE__*/function () {
  function _class() {
      ...
      var _deleteChild = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params, client) {
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return client.query("DELETE FROM bank_prixod_child  WHERE id_bank_prixod = $1", params);
            case 2:
            case "end":
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(params, client) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return client.query("UPDATE bank_prixod_child SET isdeleted = true WHERE id_bank_prixod = $1", params);
            case 2:
              _context7.next = 4;
              return client.query("UPDATE bank_prixod SET isdeleted = true WHERE id = $1 RETURNING id", params);
            case 4:
