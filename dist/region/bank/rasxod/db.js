...
var _require = require('@db/index'),
  db = _require.db;
exports.BankRasxodDB = /*#__PURE__*/function () {
  function _class() {
  ...
  return _createClass(_class, null, [{
    key: "payment",
    value: function () {
      var _payment = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(params, client) {
        var extraQuery, queryParent, queryChild, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              queryParent = "--sql\n            UPDATE bank_rasxod \n            SET tulangan_tulanmagan = $1, ".concat(extraQuery, "\n            WHERE id = $2 \n                AND isdeleted = false RETURNING id");
              queryChild = "--sql\n            UPDATE bank_rasxod_child \n            SET tulangan_tulanmagan = $1, ".concat(extraQuery, "\n            WHERE id_bank_rasxod = $2 AND isdeleted = false;\n        ");
              _context.next = 6;
              return client.query(queryChild, params);
            case 6:
              _context.next = 8;
              return client.query(queryParent, params);
            case 8:
    ...
    key: "createChild",
    value: function () {
      var _createChild = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params, _values, client) {
        var query, result;
      ...
      function createChild(_x5, _x6, _x7) {
    ...
    key: "get",
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(params) {
        var search,
          search_filter,
          query,
          result,
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              search = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : null;
              search_filter = "";
              if (search) {
                params.push(search);
    ...
    key: "update",
    value: function () {
      var _update = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params, client) {
        var result;
    ...
    key: "deleteChild",
    value: function () {
      var _deleteChild = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(params, client) {
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return client.query("DELETE FROM bank_rasxod_child  WHERE id_bank_rasxod = $1", params);
            case 2:
            case "end":
      ...
      function deleteChild(_x13, _x14) {
        return _deleteChild.apply(this, arguments);
      }
      return deleteChild;
    }()
  }, {
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(params, client) {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              _context8.next = 2;
              return client.query("UPDATE bank_rasxod_child SET isdeleted = true WHERE id_bank_rasxod = $1", params);
            case 2:
              _context8.next = 4;
              return client.query("UPDATE bank_rasxod SET isdeleted = true WHERE id = $1 RETURNING id", params);
            case 4:
    ...
    key: "fio",
    value: function () {
      var _fio = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(params) {
        var query, result;
