...
var _require2 = require('../doc/db'),
  DocRealCost = _require2.DocRealCost;
var _require3 = require('@helper/data'),
  typeDocuments = _require3.typeDocuments;
var _require4 = require('@smeta_grafik/db'),
  SmetaGrafikDB = _require4.SmetaGrafikDB;
  ...
  return _createClass(_class, null, [{
    ...
    value: function () {
      var _getInfo = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
        var types, _yield$SmetaGrafikDB$, smeta_grafiks, _iterator, _step, type, _iterator2, _step2, grafik;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              type = _step.value;
              type.smeta_grafiks = smeta_grafiks.map(function (item) {
                return _objectSpread({}, item);
              });
              _iterator2 = _createForOfIteratorHelper(type.smeta_grafiks);
              _context.prev = 12;
              _iterator2.s();
            case 14:
              ...
              grafik = _step2.value;
              _context.next = 18;
              return DocRealCost.getSummaByGrafikId([data.region_id, data.year, data.month, data.budjet_id, grafik.id, type.type]);
            case 18:
            ...
            case 0:
              ...
              return db.transaction(/*#__PURE__*/function () {
                var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(client) {
                  var result, _iterator3, _step3, type, _iterator4, _step4, grafik;
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                      ...
                      case 4:
                        ...
                        type = _step3.value;
                        _iterator4 = _createForOfIteratorHelper(type.smeta_grafiks);
                        _context2.prev = 7;
                        _iterator4.s();
                      case 9:
                        ...
                        _context2.t0 = result;
                        _context2.next = 14;
                        return ReportMainBookDB.createReport([data.user_id, tashkentTime(), null, null, data.main_schet_id, data.budjet_id, grafik.id, type.type, data.month, data.year, grafik.summa.debet_sum, grafik.summa.kredit_sum, 1, tashkentTime(), tashkentTime()], client);
                      case 14:
    ...
    value: function () {
      var _getByIdReport = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(data) {
        var report, _yield$SmetaGrafikDB$2, smeta_grafiks, _iterator6, _step6, type, _iterator7, _step7, grafik;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 12:
              ...
              _iterator7 = _createForOfIteratorHelper(type.smeta_grafiks);
              _context5.prev = 16;
              _iterator7.s();
            case 18:
              ...
              grafik = _step7.value;
              _context5.next = 22;
              return ReportMainBookDB.getSchetSummaBySchetId([data.region_id, data.year, data.month, data.budjet_id, grafik.id, type.type]);
            case 22:
            ...
            case 0:
              ...
              return db.transaction(/*#__PURE__*/function () {
                var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(client) {
                  var result, _iterator8, _step8, type, _iterator9, _step9, grafik;
                  return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                    while (1) switch (_context6.prev = _context6.next) {
                      ...
                      case 6:
                        ...
                        type = _step8.value;
                        _iterator9 = _createForOfIteratorHelper(type.smeta_grafiks);
                        _context6.prev = 9;
                        _iterator9.s();
                      case 11:
                        ...
                        _context6.t0 = result;
                        _context6.next = 16;
                        return ReportMainBookDB.createReport([data.user_id, tashkentTime(), null, null, data.query.main_schet_id, data.query.budjet_id, grafik.id, type.type, data.body.month, data.body.year, grafik.summa.debet_sum, grafik.summa.kredit_sum, 1, tashkentTime(), tashkentTime()], client);
                      case 16:
