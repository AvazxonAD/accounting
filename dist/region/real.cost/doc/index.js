...
var _require3 = require("./schema"),
  ...
  getByGrafikSchema = _require3.getByGrafikSchema;
var _require4 = require('express'),
  Router = _require4.Router;
var router = Router();
router.post('/', validator(Controller.createDoc, createDocSchema)).get('/id', validator(Controller.getByIdDoc, getByIdDocSchema)).put('/', validator(Controller.updateDoc, updateDocSchema))["delete"]('/', validator(Controller.deleteDoc, deleteDocSchema)).get('/by/schet', validator(Controller.getByGrafikSumma, getByGrafikSchema)).get('/', validator(Controller.getDoc, getDocSchema));
