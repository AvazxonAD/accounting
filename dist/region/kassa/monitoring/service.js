...
var _require = require('./db'),
  KassaMonitoringDB = _require.KassaMonitoringDB;
...
exports.KassaMonitoringService = /*#__PURE__*/function () {
  function _class() {
      ...
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return KassaMonitoringDB.get([data.region_id, data.main_schet_id, data.from, data.to, data.offset, data.limit], data.search);
            case 2:
              ...
              _context.next = 9;
              return KassaMonitoringDB.getSumma([data.region_id, data.main_schet_id, data.from], '<');
            case 9:
              summa_from = _context.sent;
              _context.next = 12;
              return KassaMonitoringDB.getSumma([data.region_id, data.main_schet_id, data.to], '<=');
            case 12:
      ...
      var _cap = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return KassaMonitoringDB.getSchets([data.region_id, data.main_schet_id, data.from, data.to]);
            case 2:
            ...
            case 6:
              ...
              schet = _step2.value;
              _context2.next = 10;
              return KassaMonitoringDB.getSummaSchet([data.region_id, data.main_schet_id, data.from, data.to, schet.schet]);
            case 10:
      ...
      var _capExcel = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              title = "\u0414\u043D\u0435\u0432\u043D\u043E\u0439 \u043E\u0442\u0447\u0435\u0442 \u043F\u043E ".concat(data.report_title.name, " \u21161. \u0421\u0447\u0435\u0442: ").concat(data.main_schet.jur1_schet, ". \u04B2\u0438\u0441\u043E\u0431 \u0440\u0430\u049B\u0430\u043C\u0438: ").concat(returnStringSumma(data.main_schet.account_number));
              dateBetween = "\u0417\u0430 \u043F\u0435\u0440\u0438\u043E\u0434 \u0441 ".concat(returnStringDate(new Date(data.from)), " \u043F\u043E ").concat(returnStringDate(new Date(data.to)));
              workbook = new ExcelJS.Workbook();
              fileName = "kassa_shapka_".concat(new Date().getTime(), ".xlsx");
      ...
      var _daily = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return KassaMonitoringDB.daily([data.main_schet_id, data.from, data.to, data.region_id]);
            case 2:
              result = _context4.sent;
              _context4.next = 5;
              return KassaMonitoringDB.dailySumma([data.region_id, data.main_schet_id, data.from], '<');
            case 5:
              balance_from = _context4.sent;
              _context4.next = 8;
              return KassaMonitoringDB.dailySumma([data.region_id, data.main_schet_id, data.to], '<=');
            case 8:
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              dateBetween = "\u0417\u0430 \u043F\u0435\u0440\u0438\u043E\u0434 \u0441 ".concat(returnStringDate(new Date(data.from)), " \u043F\u043E ").concat(returnStringDate(new Date(data.to)));
              workbook = new ExcelJS.Workbook();
              fileName = "kundalik_hisobot_kassa_".concat(new Date().getTime(), ".xlsx");
              worksheet = workbook.addWorksheet('Hisobot');
              worksheet.mergeCells('A1', 'G1');
              titleCell = worksheet.getCell('A1');
              Object.assign(titleCell, {
