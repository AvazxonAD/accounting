...
var _require = require('@db/index'),
  db = _require.db;
exports.KassaMonitoringDB = /*#__PURE__*/function () {
  function _class() {
  ...
  return _createClass(_class, null, [{
    key: "get",
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(params, search) {
    ...
    key: "getSumma",
    value: function () {
      var _getSumma = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params, operator) {
        var query, result;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              query = "\n            WITH prixod AS (\n                SELECT \n                    COALESCE(SUM(ch.summa), 0)::FLOAT AS summa\n                FROM kassa_prixod d\n                JOIN kassa_prixod_child ch ON ch.kassa_prixod_id = d.id\n                JOIN users u ON d.user_id = u.id\n                JOIN regions r ON u.region_id = r.id\n                WHERE r.id = $1 \n                    AND d.main_schet_id = $2 \n                    AND d.doc_date ".concat(operator, " $3 \n                    AND d.isdeleted = false\n                    AND ch.isdeleted = false\n            ), \n            rasxod AS (\n                SELECT \n                    COALESCE(SUM(ch.summa), 0)::FLOAT AS summa\n                FROM kassa_rasxod d\n                JOIN kassa_rasxod_child ch ON ch.kassa_rasxod_id = d.id\n                JOIN users u ON d.user_id = u.id\n                JOIN regions r ON u.region_id = r.id\n                WHERE r.id = $1 \n                    AND d.main_schet_id = $2 \n                    AND d.doc_date ").concat(operator, " $3 \n                    AND d.isdeleted = false\n                    AND ch.isdeleted = false\n            )\n            SELECT \n                prixod.summa AS prixod_summa,\n                rasxod.summa AS rasxod_summa,\n                (prixod.summa - rasxod.summa) AS summa\n            FROM prixod, rasxod;\n        ");
              _context2.next = 3;
              return db.query(query, params);
            case 3:
    ...
    key: "daily",
    value: function () {
      var _daily = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params) {
        var query, result;
    ...
    key: "dailySumma",
    value: function () {
      var _dailySumma = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(params, operator) {
        var query, result;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              return _context4.abrupt("return", result[0].summa);
            case 5:
            case "end":
      ...
      function dailySumma(_x6, _x7) {
        return _dailySumma.apply(this, arguments);
      }
      return dailySumma;
    }()
  }, {
    key: "getSchets",
    value: function () {
      var _getSchets = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(params) {
        var query, result;
    ...
    key: "getSummaSchet",
    value: function () {
      var _getSummaSchet = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params) {
        var query, result;
      ...
      function getSummaSchet(_x9) {
        return _getSummaSchet.apply(this, arguments);
      }
      return getSummaSchet;
    }()
  }]);
}();