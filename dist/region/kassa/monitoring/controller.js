...
var _require = require('./service'),
  KassaMonitoringService = _require.KassaMonitoringService;
  ...
  return _createClass(_class, null, [{
    ...
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var region_id, _req$query, page, limit, main_schet_id, offset, main_schet, _yield$KassaMonitorin, total_count, data, summa_from, summa_to, prixod_sum, rasxod_sum, page_prixod_sum, page_rasxod_sum, page_total_sum, pageCount, meta;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 8:
              _context.next = 10;
              return KassaMonitoringService.get(_objectSpread(_objectSpread({}, req.query), {}, {
                region_id: region_id,
                offset: offset,
                limit: limit
              }));
            case 10:
              _yield$KassaMonitorin = _context.sent;
              total_count = _yield$KassaMonitorin.total_count;
              data = _yield$KassaMonitorin.data;
              summa_from = _yield$KassaMonitorin.summa_from;
              summa_to = _yield$KassaMonitorin.summa_to;
              prixod_sum = _yield$KassaMonitorin.prixod_sum;
              rasxod_sum = _yield$KassaMonitorin.rasxod_sum;
              page_prixod_sum = _yield$KassaMonitorin.page_prixod_sum;
              page_rasxod_sum = _yield$KassaMonitorin.page_rasxod_sum;
              page_total_sum = _yield$KassaMonitorin.page_total_sum;
    ...
    value: function () {
      var _cap = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var _req$query2, from, to, main_schet_id, excel, report_title_id, region_id, region, report_title, main_schet, data, _yield$KassaMonitorin2, fileName, filePath;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 15:
              _context2.next = 17;
              return KassaMonitoringService.cap({
                region_id: region_id,
            ...
            case 17:
              data = _context2.sent;
              _context2.next = 20;
              return KassaMonitoringService.capExcel(_objectSpread(_objectSpread({}, data), {}, {
            ...
            case 20:
              _yield$KassaMonitorin2 = _context2.sent;
              fileName = _yield$KassaMonitorin2.fileName;
              filePath = _yield$KassaMonitorin2.filePath;
              if (!(excel === 'true')) {
                _context2.next = 27;
                break;
              }
    ...
    value: function () {
      var _daily = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        var _req$query3, from, to, main_schet_id, report_title_id, region_id, region, report_title, main_schet, data, _yield$KassaMonitorin3, fileName, filePath;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 15:
              _context3.next = 17;
              return KassaMonitoringService.daily({
                region_id: region_id,
                main_schet_id: main_schet_id,
                from: from,
                to: to
            ...
            case 17:
              data = _context3.sent;
              _context3.next = 20;
              return KassaMonitoringService.dailyExcel(_objectSpread(_objectSpread({}, data), {}, {
                region: region,
                from: from,
                to: to,
                main_schet: main_schet,
            ...
            case 20:
              _yield$KassaMonitorin3 = _context3.sent;
              fileName = _yield$KassaMonitorin3.fileName;
              filePath = _yield$KassaMonitorin3.filePath;
              res.setHeader('Content-Type', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
              res.setHeader('Content-Disposition', "attachment; filename=\"".concat(fileName, "\""));
