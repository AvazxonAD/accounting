...
var _require8 = require('./service'),
  KassaRasxodService = _require8.KassaRasxodService;
  ...
  return _createClass(_class, null, [{
      ...
      var _create = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 57:
              _context.next = 59;
              return KassaRasxodService.create(_objectSpread(_objectSpread({}, req.body), {}, {
    ...
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var region_id, _req$query, page, limit, main_schet_id, main_schet, offset, _yield$KassaRasxodSer, data, total_count, summa, page_summa, pageCount, meta;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 7:
              offset = (page - 1) * limit;
              _context2.next = 10;
              return KassaRasxodService.get(_objectSpread({
                region_id: region_id,
                offset: offset
              }, req.query));
            case 10:
              _yield$KassaRasxodSer = _context2.sent;
              data = _yield$KassaRasxodSer.data;
              total_count = _yield$KassaRasxodSer.total_count;
              summa = _yield$KassaRasxodSer.summa;
              page_summa = _yield$KassaRasxodSer.page_summa;
      ...
      var _getById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 8:
              _context3.next = 10;
              return KassaRasxodService.getById({
                region_id: region_id,
                main_schet_id: main_schet_id,
                id: id
              });
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 61:
              ...
              _context4.next = 64;
              return KassaRasxodService.update(_objectSpread(_objectSpread({}, req.body), {}, {
                main_schet_id: main_schet_id,
                user_id: user_id,
                id: id
              }));
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 13:
              _context5.next = 15;
              return KassaRasxodService["delete"]({
                id: id
              });
            case 15:
