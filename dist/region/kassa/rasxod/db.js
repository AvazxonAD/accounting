...
var _require = require('@db/index'),
  db = _require.db;
exports.KassaRasxodDB = /*#__PURE__*/function () {
  function _class() {
  ...
  return _createClass(_class, null, [{
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              if (search) {
                params.push(search);
                search_filter = "AND (\n                d.doc_num = $".concat(params.length, " OR \n                p.name ILIKE '%' || $").concat(params.length, " || '%'\n            )");
              }
    ...
    value: function () {
      var _deleteChild = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params, client) {
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return client.query("DELETE FROM kassa_rasxod_child  WHERE kassa_rasxod_id = $1", params);
            case 2:
            case "end":
      ...
      function deleteChild(_x12, _x13) {
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(params, client) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return client.query("UPDATE kassa_rasxod_child SET isdeleted = true WHERE kassa_rasxod_id = $1", params);
            case 2:
              _context7.next = 4;
              return client.query("UPDATE kassa_rasxod SET isdeleted = true WHERE id = $1 RETURNING id", params);
            case 4:
