...
exports.Jur7RsxodService = /*#__PURE__*/function () {
  function _class() {
  ...
  return _createClass(_class, null, [{
                ...
                var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(client) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return RasxodDB["delete"]([data.id], client);
                      case 2:
                        doc = _context.sent;
                ...
                var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(client) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                      case 0:
                        _context3.next = 2;
                        return RasxodDB.create([data.user_id, data.doc_num, data.doc_date, data.j_o_num, data.opisanie, data.doverennost, summa, data.kimdan_id, data.kimdan_name, data.kimga_id, data.kimga_name, data.id_shartnomalar_organization, data.main_schet_id, tashkentTime(), tashkentTime()], client);
                      case 2:
                        doc = _context3.sent;
                        _context3.next = 5;
    ...
    value: function () {
      var _createChild = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(data) {
        var create_childs, _iterator3, _step3, child, _values;
            ...
            case 0:
              ...
              try {
                for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                  child = _step3.value;
                  create_childs.push(child.naimenovanie_tovarov_jur7_id, child.kol, child.sena, child.summa, child.debet_schet, child.debet_sub_schet, child.kredit_schet, child.kredit_sub_schet, child.data_pereotsenka, data.user_id, data.docId, data.main_schet_id, child.iznos, child.iznos_summa, child.iznos_schet, child.iznos_sub_schet, tashkentTime(), tashkentTime());
                }
              } catch (err) {
                _iterator3.e(err);
              } finally {
              ...
              _values = returnParamsValues(create_childs, 18);
              _context5.next = 6;
              return RasxodDB.createChild(create_childs, _values, data.client);
            case 6:
            case "end":
                ...
                var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(client) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                    while (1) switch (_context6.prev = _context6.next) {
                      case 0:
                        _context6.next = 2;
                        return RasxodDB.update([data.doc_num, data.doc_date, data.j_o_num, data.opisanie, data.doverennost, summa, data.kimdan_id, data.kimdan_name, tashkentTime(), data.id], client);
                      case 2:
                        doc = _context6.sent;
                        _context6.next = 5;
                        return RasxodDB.deleteRasxodChild([data.id], client);
                      case 5:
                        _context6.next = 7;
      ...
      var _getById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              _context8.next = 2;
              return RasxodDB.getById([data.region_id, data.id, data.main_schet_id], data.isdeleted);
            case 2:
      ...
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              _context9.next = 2;
              return RasxodDB.get([data.region_id, data.from, data.to, data.main_schet_id, data.offset, data.limit], data.search);
            case 2:
