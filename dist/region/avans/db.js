...
var _require = require('@db/index'),
  db = _require.db;
exports.AvansDB = /*#__PURE__*/function () {
  function _class() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (search) {
                params.push(search);
                search_filter = " AND (\n                d.doc_num = $".concat(params.length, " OR \n                sp.name ILIKE '%' || $").concat(params.length, " || '%'\n            )");
              }
      ...
      var _deleteChild = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params, client) {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              query = "DELETE FROM avans_otchetlar_jur4_child WHERE avans_otchetlar_jur4_id = $1";
              _context6.next = 3;
              return client.query(query, params);
            case 3:
            case "end":
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(params, client) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return client.query("UPDATE avans_otchetlar_jur4_child SET isdeleted = true WHERE avans_otchetlar_jur4_id = $1", params);
            case 2:
              _context7.next = 4;
              return client.query("UPDATE avans_otchetlar_jur4 SET  isdeleted = true WHERE id = $1 RETURNING id", params);
            case 4:
