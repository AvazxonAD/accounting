...
var _require5 = require('../spravochnik/podotchet/service'),
  PodotchetService = _require5.PodotchetService;
var _require6 = require('@operatsii/service'),
  OperatsiiService = _require6.OperatsiiService;
var _require7 = require('../spravochnik/sostav/service'),
  SostavService = _require7.SostavService;
var _require8 = require('../spravochnik/type.operatsii/service'),
  TypeOperatsiiService = _require8.TypeOperatsiiService;
  ...
  return _createClass(_class, null, [{
    ...
    value: function () {
      var _create = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var _req$body, spravochnik_podotchet_litso_id, spravochnik_operatsii_own_id, childs, region_id, user_id, main_schet_id, main_schet, operatsii, podotchet, operatsiis, _iterator, _step, child, _operatsii, podraz, sostav, _operatsii2, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _req$body = req.body, spravochnik_podotchet_litso_id = _req$body.spravochnik_podotchet_litso_id, spravochnik_operatsii_own_id = _req$body.spravochnik_operatsii_own_id, childs = _req$body.childs;
    ...
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var region_id, _req$query, page, limit, from, to, main_schet_id, search, main_schet, offset, _yield$AktService$get, summa, total_count, data, page_summa, pageCount, meta;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 10:
              ...
              total_count = _yield$AktService$get.total_count;
    ...
    value: function () {
      var _update = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        var _req$body2, spravochnik_podotchet_litso_id, spravochnik_operatsii_own_id, childs, region_id, user_id, main_schet_id, id, old_data, operatsii, podotchet, operatsiis, _iterator2, _step2, child, _operatsii3, podraz, sostav, _operatsii4, result;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _req$body2 = req.body, spravochnik_podotchet_litso_id = _req$body2.spravochnik_podotchet_litso_id, spravochnik_operatsii_own_id = _req$body2.spravochnik_operatsii_own_id, childs = _req$body2.childs;
              region_id = req.user.region_id;
              user_id = req.user.id;
              main_schet_id = req.query.main_schet_id;
              id = req.params.id;
