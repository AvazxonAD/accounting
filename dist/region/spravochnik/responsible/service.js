...
var _require = require('./db'),
  ResponsibleDB = _require.ResponsibleDB;
...
exports.ResponsibleService = /*#__PURE__*/function () {
  function _class() {
  ...
  return _createClass(_class, null, [{
      ...
      var _export2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 15:
              fileName = "responsibles.".concat(new Date().getTime(), ".xlsx");
    ...
    key: "readFile",
    value: function () {
      var _readFile = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
      ...
      var _getById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(data) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return ResponsibleDB.getById([data.id], data.region_id, data.isdeleted);
            case 2:
    ...
    key: "getByFio",
    value: function () {
      var _getByFio = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(data) {
        var result;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return ResponsibleDB.getByFio([data.region_id, data.fio]);
            case 2:
    ...
    key: "get",
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(data) {
        var result;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return ResponsibleDB.get([data.offset, data.limit], data.region_id, data.search, data.podraz_id);
            case 2:
    ...
    value: function () {
      var _createResponsible = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(data) {
        var result;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return ResponsibleDB.createResponsible([data.podraz_id, data.fio, data.user_id, tashkentTime(), tashkentTime()], data.client);
            case 2:
      ...
      function createResponsible(_x6) {
    ...
    key: "import",
    value: function () {
      var _import2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(data) {
        var _this = this;
                  ...
                  while (1) switch (_context9.prev = _context9.next) {
                    case 0:
                      ...
                      return db.transaction(/*#__PURE__*/function () {
                        var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(client) {
                          return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                            while (1) switch (_context8.prev = _context8.next) {
                              case 0:
                                _context8.next = 2;
                                return _this.createResponsible({
                                  client: client,
                                  podraz_id: item.spravochnik_podrazdelenie_jur7_id,
